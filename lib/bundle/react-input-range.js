...
var InputRange = (_class = function (_React$Component) {
  ...
  _createClass(InputRange, [{
    ...
    key: 'updatePositionsRelative',
    value: function updatePositionsRelative(startPositions, start, end) {
      var variance = { x: end.x - start.x, y: end.y - start.y };
    ...
    value: function handleTrackMouseDown(event, position) {
      ...
      var currentValues = valueTransformer.getValueFromProps(this.props, this.isMultiValue());
      var currentPositions = valueTransformer.getPositionsFromValues(currentValues, this.props.minValue, this.props.maxValue, this.getTrackClientRect());
    ...
    key: 'handleTrackMouseUp',
    value: function handleTrackMouseUp(event) {
      if (this.props.disabled) {
        return;
      }
    ...
    key: 'handleTrackDrag',
    value: function handleTrackDrag(event, position) {
      var _this3 = this;
      ...
      var startPosition = Object.assign({}, this.dragStartPosition);
      var startPositions = Object.assign({}, this.dragStartPositions);

      requestAnimationFrame(function () {
        return _this3.updatePositionsRelative(startPositions, startPosition, position);
      });
    }
    ...
    value: function renderSliders() {
      ...
      return this.getKeys().map(function (key) {
        ...
        var slider = _react2.default.createElement(_slider2.default, {
          ariaLabelledby: _this4.props.ariaLabelledby,
          ariaControls: _this4.props.ariaControls,
          classNames: _this4.props.classNames,
          formatLabel: _this4.props.formatLabel,
          key: key,
          maxValue: maxValue,
          minValue: minValue,
          onSliderDrag: _this4.handleSliderDrag,
          onSliderKeyDown: _this4.handleSliderKeyDown,
    ...
    value: function renderHiddenInputs() {
      ...
      return this.getKeys().map(function (key) {
        var value = values[key];
        var name = isMultiValue ? '' + _this5.props.name + (0, _utils.captialize)(key) : _this5.props.name;
